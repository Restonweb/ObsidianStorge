...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#arp-spoofing-1)

ARP Spoofing ARP 欺骗

Check the [previous section](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#arp-spoofing).  
查看上一节。

### 

[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#icmpredirect)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#dns-spoofing)
...
**Configure own DNS with dnsmasq 使用 dnsmasq 配置自己的 DNS**
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#local-gateways)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#spoofing-llmnr-nbt-ns-and-mdns)

[Spoofing LLMNR, NBT-NS, and mDNS  
欺骗 LLMNR、NBT-NS 和 mDNS](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network/spoofing-llmnr-nbt-ns-mdns-dns-and-wpad-and-relay-attacks)
...
您可以使用 Responder 模拟主机搜索的服务来发送虚假响应。 在此处阅读有关如何使用 Responder 模拟服务的详细信息。

### 

[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#spoofing-wpad)

[Spoofing WPAD 欺骗 WPAD](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network/spoofing-llmnr-nbt-ns-mdns-dns-and-wpad-and-relay-attacks)
...
欺骗 SSDP 和 UPnP 设备](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network/spoofing-ssdp-and-upnp-devices)

You can offer different services in the network to try to **trick a user** to enter some **plain-text credentials**. **More information about this attack in** [**Spoofing SSDP and UPnP Devices**](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network/spoofing-ssdp-and-upnp-devices)**.**  
您可以在网络中提供不同的服务，以尝试诱骗用户输入一些纯文本凭据。 有关此攻击的详细信息 欺骗 SSDP 和 UPnP 设备 。

### 

[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#ipv6-neighbor-spoofing)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#ipv6-router-a-dvertisement-spoofing-flooding)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#ipv6-dhcp-spoofing)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#http-fake-page-and-js-code-injection)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#internet-attacks)

Internet Attacks 互联网攻击

### 

[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#sslstrip)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#sslstrip-and-dns2proxy-for-bypassing-hsts)
...
The **goal** of this technique is to **avoid HSTS** because _**wwww**__.facebook.com_ **won't** be saved in the **cache** of the browser, so the browser will be tricked to perform **facebook authentication in HTTP**. Note that in order to perform this attack the victim has to try to access initially to [http://www.faceook.com](http://www.faceook.com/) and not https. This can be done modifying the links inside an http page.  
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#tcp-listen-in-port)

TCP listen in port TCP 侦听端口
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#tcp--ssl-listen-in-port)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#generate-keys-and-self-signed-certificate)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#listen-using-certificate)

Listen using certificate 使用证书侦听
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#listen-using-certificate-and-redirect-to-the-hosts)
...
Some times, if the client checks that the CA is a valid one, you could **serve a certificate of other hostname signed by a CA**. Another interesting test, is to serve a c**ertificate of the requested hostname but self-signed**.  
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#bettercap-2)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#active-discovery-notes)

Active Discovery Notes 活动发现说明
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#arp-discover)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#mdns-multicast-dns)

**mDNS (multicast DNS) mDNS（组播DNS）**
...
- Avahi-browser (--all) Avahi-浏览器 （--all）
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#nbns-netbios-name-server)
...
Bettercap 向端口 137/UDP 广播数据包，要求名称为“CKAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA

### 

[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#ssdp-simple-service-discovery-protocol)
...
[](https://book.hacktricks.xyz/generic-methodologies-and-resources/pentesting-network#wsd-web-service-discovery)
